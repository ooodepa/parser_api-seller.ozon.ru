...
class OZN_v3_FinanceTransactionList {
        ...
        try {
            ...
            $sql = "INSERT INTO
                        ...
                        (
                            ...
                            _posting_posting_number_1,
                            _posting_posting_number_2,
                            _posting_posting_number_3,
            ...
            for ($i = 0; $i < $length; $i++) {
                ...
                $sql .= "('"
                    . implode("','", [
                        ...
                        $DATA['_posting_posting_number_1'],
                        $DATA['_posting_posting_number_2'],
                        $DATA['_posting_posting_number_3'],
    ...
    static function recreateDatabase() {
        ...
        $sql = "CREATE TABLE $DB_NAME (
                    ...
                    _posting_posting_number_1 TEXT,
                    _posting_posting_number_2 TEXT,
                    _posting_posting_number_3 TEXT,
