...
class v1_DescriptionCategoryTreeService {
    public function executeCron() {
        global $HOME;

        $data = v1_DescriptionCategoryTreeService::getRuArray();

        $FILE_PATH = "$HOME/data/v1_DescriptionCategoryTreeService.json";
    ...
    static function getRuArray() {
        return v1_DescriptionCategoryTreeService::fetchJson([
            "language" => 'RU',
        ]);
    }
